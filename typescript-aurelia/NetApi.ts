...
/**
 * netAddrsGet - parameters interface
 */
export interface INetAddrsGetParams {
}
 ...
 */
@autoinject()
export class NetApi extends Api {

  /**
   * Creates a new NetApi class.
   *
  ...
  async netAddrsGet(): Promise<string> {
    ...
    // Create URL to call
    const url = `${this.basePath}/net/addrs`;
