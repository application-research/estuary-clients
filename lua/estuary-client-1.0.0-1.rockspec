...
build = {
	...
	modules = {
		...
		["estuary-client.api.default_api"] = "estuary-client/api/default_api.lua";
		...
		["estuary-client.model.main_user_stats_response"] = "estuary-client/model/main_user_stats_response.lua";
