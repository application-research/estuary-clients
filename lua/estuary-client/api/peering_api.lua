...
local peering_api = {}
local peering_api_mt = {
	__name = "peering_api";
	__index = peering_api;
}

local function new_peering_api(host, basePath, schemes)
	local schemes_map = {}
...
function peering_api:admin_peering_peers_delete(peer_ids)
...
function peering_api:admin_peering_peers_get()
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		path = string.format("%s/admin/peering/peers",
...
function peering_api:admin_peering_peers_post()
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		path = string.format("%s/admin/peering/peers",
...
function peering_api:admin_peering_start_post()
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
...
function peering_api:admin_peering_status_get()
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
...
function peering_api:admin_peering_stop_post()
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
