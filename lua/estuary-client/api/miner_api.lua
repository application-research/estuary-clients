...
local function new_miner_api(host, basePath, schemes)
	local schemes_map = {}
...
function miner_api:public_miners_deals_miner_get(miner, ignore_failed)
...
function miner_api:public_miners_stats_miner_get(miner)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
