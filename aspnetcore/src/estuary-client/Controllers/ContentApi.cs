...
{ 
    ...
    { 
        ...
        [HttpPost]
        [Route("//api.estuary.tech//admin/invites/{code}")]
        [Authorize(AuthenticationSchemes = ApiKeyAuthenticationHandler.SchemeName)]
        [ValidateModelState]
        [SwaggerOperation("AdminInvitesCodePost")]
        ...
        public virtual IActionResult AdminInvitesCodePost([FromRoute][Required]string code)
        { 
        ...
        [SwaggerResponse(statusCode: 400, type: typeof(UtilHttpError), description: "Bad Request")]
        [SwaggerResponse(statusCode: 500, type: typeof(UtilHttpError), description: "Internal Server Error")]
        public virtual IActionResult ContentAddIpfsPost([FromBody]PinnerIpfsPin body, [FromQuery]string ignoreDupes, [FromQuery]string overwrite)
        { 
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(string));
        ...
        /// </summary>
        /// <remarks>This endpoint is used to get content statistics. Every content stored in the network (estuary) is tracked by a unique ID which can be used to get information about the content. This endpoint will allow the consumer to get the collected stats of a content</remarks>
        /// <param name="limit">limit</param>
        /// <param name="offset">offset</param>
        /// <response code="200">OK</response>
        /// <response code="400">Bad Request</response>
