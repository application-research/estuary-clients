...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ApiMinerResp : IEquatable<ApiMinerResp>
    { 
        /// <summary>
        /// Gets or Sets Addr
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ApiMinerResp)obj);
        }

        /// <summary>
        /// Returns true if ApiMinerResp instances are equal
        /// </summary>
        /// <param name="other">Instance of ApiMinerResp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiMinerResp other)
        {
            ...
            return 
                ...
                (
                    ...
                    ChainInfo != null &&
                    ChainInfo.Equals(other.ChainInfo)
                ) && 
                (
                    Name == other.Name ||
                    Name != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (ChainInfo != null)
                    hashCode = hashCode * 59 + ChainInfo.GetHashCode();
                    if (Name != null)
        ...
        public static bool operator ==(ApiMinerResp left, ApiMinerResp right)
        {
