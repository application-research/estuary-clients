...
${nuget_cmd} install src/estuary-client/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/estuary-client.dll"
...
then
  ...
  echo "[INFO] bin/estuary-client.dll was created successfully"
fi
