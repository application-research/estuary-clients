...
${nuget_cmd} install src/estuary_client/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/estuary_client.dll"
...
then
  ...
  echo "[INFO] bin/estuary_client.dll was created successfully"
fi
