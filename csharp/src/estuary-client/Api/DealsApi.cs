...
namespace estuary-client.Api
{
        ...
        public interface IDealsApi : IApiAccessor
    {
        ...
        /// <param name="miner">Miner</param>
        /// <returns>ApiResponse of string</returns>
        ApiResponse<string> DealsMakeMinerPostWithHttpInfo (string body, string miner);
        /// <summary>
        /// Get Deal Status
        /// </summary>
        /// <remarks>
        ...
        /// <param name="miner">Miner</param>
        /// <returns>Task of string</returns>
        System.Threading.Tasks.Task<string> DealsMakeMinerPostAsync (string body, string miner);
        ...
        /// <param name="miner">Miner</param>
        /// <returns>Task of ApiResponse (string)</returns>
        System.Threading.Tasks.Task<ApiResponse<string>> DealsMakeMinerPostAsyncWithHttpInfo (string body, string miner);
        /// <summary>
        /// Get Deal Status
        /// </summary>
        /// <remarks>
        ...
        public partial class DealsApi : IDealsApi
    {
        ...
        public ApiResponse< string > DealTransferStatusPostWithHttpInfo (MainChannelIDParam body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling DealsApi->DealTransferStatusPost");
        ...
        {
             ApiResponse<string> localVarResponse = DealsMakeMinerPostWithHttpInfo(body, miner);
             return localVarResponse.Data;
        }
        ...
        /// <param name="miner">Miner</param>
        /// <returns>ApiResponse of string</returns>
        public ApiResponse< string > DealsMakeMinerPostWithHttpInfo (string body, string miner)
        {
            // verify the required parameter 'body' is set
            if (body == null)
        ...
        /// <param name="miner">Miner</param>
        /// <returns>Task of string</returns>
        public async System.Threading.Tasks.Task<string> DealsMakeMinerPostAsync (string body, string miner)
        {
             ApiResponse<string> localVarResponse = await DealsMakeMinerPostAsyncWithHttpInfo(body, miner);
             return localVarResponse.Data;
        ...
        /// <param name="miner">Miner</param>
        /// <returns>Task of ApiResponse (string)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<string>> DealsMakeMinerPostAsyncWithHttpInfo (string body, string miner)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling DealsApi->DealsMakeMinerPost");
