...
namespace estuary-client.Api
{
    ...
    public partial class PeersApi : IPeersApi
    {
        ...
        /// <returns></returns>
        public PeersApi(estuary-client.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse< string > AdminPeeringPeersDeleteWithHttpInfo (List<bool?> peerIds)
        {
            ...
            if (peerIds == null)
                throw new ApiException(400, "Missing required parameter 'peerIds' when calling PeersApi->AdminPeeringPeersDelete");
