...
namespace estuary-client.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class UtilDbCID :  IEquatable<UtilDbCID>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UtilDbCID" /> class.
        /// </summary>
        /// <param name="cid">cid.</param>
        public UtilDbCID(CidCid cid = default(CidCid))
        {
            this.Cid = cid;
        }
        ...
        {
            return this.Equals(input as UtilDbCID);
        }

        /// <summary>
        /// Returns true if UtilDbCID instances are equal
        /// </summary>
        /// <param name="input">Instance of UtilDbCID to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UtilDbCID input)
        {
            if (input == null)
                return false;
