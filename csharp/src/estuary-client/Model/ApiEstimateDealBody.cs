...
namespace estuary-client.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApiEstimateDealBody :  IEquatable<ApiEstimateDealBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiEstimateDealBody" /> class.
        /// </summary>
        /// <param name="durationBlks">durationBlks.</param>
        /// <param name="replication">replication.</param>
        /// <param name="size">size.</param>
        /// <param name="verified">verified.</param>
        public ApiEstimateDealBody(int? durationBlks = default(int?), int? replication = default(int?), int? size = default(int?), bool? verified = default(bool?))
        {
        ...
        {
            return this.Equals(input as ApiEstimateDealBody);
        }

        /// <summary>
        /// Returns true if ApiEstimateDealBody instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiEstimateDealBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiEstimateDealBody input)
        {
            if (input == null)
                return false;
