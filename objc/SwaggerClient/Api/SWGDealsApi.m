...
@implementation SWGDealsApi

NSString* kSWGDealsApiErrorDomain = @"SWGDealsApiErrorDomain";
NSInteger kSWGDealsApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) dealEstimatePostWithBody: (SWGMainEstimateDealBody*) body
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/deal/estimate"];
...
-(NSURLSessionTask*) dealInfoDealidGetWithDealid: (NSNumber*) dealid
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/deal/info/{dealid}"];

    NSMutableDictionary *pathParams = [[NSMutableDictionary alloc] init];
    if (dealid != nil) {
        pathParams[@"dealid"] = dealid;
    }
...
-(NSURLSessionTask*) dealProposalPropcidGetWithPropcid: (NSString*) propcid
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/deal/proposal/{propcid}"];

    NSMutableDictionary *pathParams = [[NSMutableDictionary alloc] init];
    if (propcid != nil) {
        pathParams[@"propcid"] = propcid;
    }
...
-(NSURLSessionTask*) dealQueryMinerGetWithMiner: (NSString*) miner
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/deal/query/{miner}"];
...
-(NSURLSessionTask*) dealStatusByProposalPropcidGetWithPropcid: (NSString*) propcid
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/deal/status-by-proposal/{propcid}"];
...
-(NSURLSessionTask*) dealStatusMinerPropcidGetWithMiner: (NSString*) miner
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/deal/status/{miner}/{propcid}"];
...
-(NSURLSessionTask*) dealsMakeMinerPostWithMiner: (NSString*) miner
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/deals/make/{miner}"];
...
-(NSURLSessionTask*) dealsStatusDealGetWithDeal: (NSNumber*) deal
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/deals/status/{deal}"];

    NSMutableDictionary *pathParams = [[NSMutableDictionary alloc] init];
    if (deal != nil) {
        pathParams[@"deal"] = deal;
    }
...
-(NSURLSessionTask*) publicMinersStorageQueryMinerGetWithMiner: (NSString*) miner
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/public/miners/storage/query/{miner}"];
