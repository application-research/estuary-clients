#import "SWGPeersApi.h"
#import "SWGQueryParamCollection.h"
#import "SWGApiClient.h"


@interface SWGPeersApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGPeersApi

NSString* kSWGPeersApiErrorDomain = @"SWGPeersApiErrorDomain";
NSInteger kSWGPeersApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) adminPeeringPeersDeleteWithBody: (NSArray<NSString*>*) body
    ...
    if (body == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGPeersApiErrorDomain code:kSWGPeersApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }
