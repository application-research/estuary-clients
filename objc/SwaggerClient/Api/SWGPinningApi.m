...
@interface SWGPinningApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGPinningApi

NSString* kSWGPinningApiErrorDomain = @"SWGPinningApiErrorDomain";
NSInteger kSWGPinningApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) pinningPinsPinidDeleteWithPinid: (NSString*) pinid
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/pinning/pins/{pinid}"];

    NSMutableDictionary *pathParams = [[NSMutableDictionary alloc] init];
    if (pinid != nil) {
        pathParams[@"pinid"] = pinid;
    }
