...
export class AdminService {
     ...
     */
    public adminSystemConfigGet(observe?: 'body', headers?: Headers): Observable<any>;
    public adminSystemConfigGet(observe?: 'response', headers?: Headers): Observable<HttpResponse<any>>;
    public adminSystemConfigGet(observe: any = 'body', headers: Headers = {}): Observable<any> {
        ...
        const response: Observable<HttpResponse<any>> = this.httpClient.get(`${this.APIConfiguration.basePath}/admin/system/config` as any, headers);
        if (observe === 'body') {
               return response.map(httpResponse => httpResponse.response);
        }
        return response;
     ...
     */
    public adminUsersGet(observe?: 'body', headers?: Headers): Observable<any>;
    public adminUsersGet(observe?: 'response', headers?: Headers): Observable<HttpResponse<any>>;
    public adminUsersGet(observe: any = 'body', headers: Headers = {}): Observable<any> {
        ...
        const response: Observable<HttpResponse<any>> = this.httpClient.get(`${this.APIConfiguration.basePath}/admin/users` as any, headers);
        if (observe === 'body') {
               return response.map(httpResponse => httpResponse.response);
        }
        return response;
