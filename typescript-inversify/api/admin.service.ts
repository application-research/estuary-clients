...
export class AdminService {
     ...
     */
    public adminSystemConfigGet(observe?: 'body', headers?: Headers): Observable<string>;
    public adminSystemConfigGet(observe?: 'response', headers?: Headers): Observable<HttpResponse<string>>;
    public adminSystemConfigGet(observe: any = 'body', headers: Headers = {}): Observable<any> {
        // authentication (bearerAuth) required
        if (this.APIConfiguration.apiKeys['Authorization']) {
            headers['Authorization'] = this.APIConfiguration.apiKeys['Authorization'];
        }
        ...
        const response: Observable<HttpResponse<string>> = this.httpClient.get(`${this.APIConfiguration.basePath}/admin/system/config` as any, headers);
        if (observe === 'body') {
               return response.map(httpResponse => httpResponse.response);
        }
        return response;
     ...
     */
    public adminUsersGet(observe?: 'body', headers?: Headers): Observable<string>;
    public adminUsersGet(observe?: 'response', headers?: Headers): Observable<HttpResponse<string>>;
    public adminUsersGet(observe: any = 'body', headers: Headers = {}): Observable<any> {
        // authentication (bearerAuth) required
        if (this.APIConfiguration.apiKeys['Authorization']) {
            headers['Authorization'] = this.APIConfiguration.apiKeys['Authorization'];
        }
        ...
        const response: Observable<HttpResponse<string>> = this.httpClient.get(`${this.APIConfiguration.basePath}/admin/users` as any, headers);
        if (observe === 'body') {
               return response.map(httpResponse => httpResponse.response);
        }
        return response;
