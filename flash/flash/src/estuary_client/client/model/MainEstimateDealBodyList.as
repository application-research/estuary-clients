...
import io.swagger.common.ListWrapper;
    ...
    public class MainEstimateDealBodyList implements ListWrapper {
        ...
        private var _mainEstimateDealBody_obj_class: estuary_client.client.model.MainEstimateDealBody = null;
        [XmlElements(name="mainEstimateDealBody", type="estuary_client.client.model.MainEstimateDealBody")]
