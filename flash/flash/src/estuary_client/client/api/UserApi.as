...
import estuary_client.client.model.MainGetApiKeysResp;
import estuary_client.client.model.MainUserStatsResponse;
...
public class UserApi extends SwaggerApi {
    ...
    */
     ...
     */
    public function user_api_keys_post (): String {
        // create path and map variables
        var path: String = "/user/api-keys".replace(/{format}/g,"xml");
