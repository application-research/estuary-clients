...
object PublicApi {
  ...
  def publicByCidCidGet(host: String, cid: String): Task[Unit] = {
    val path = "/public/by-cid/{cid}".replaceAll("\\{" + "cid" + "\\}",escape(cid.toString))
  ...
  def publicInfoGet(host: String): Task[Unit] = {
    val path = "/public/info"
  ...
  def publicMinersFailuresMinerGet(host: String, miner: String): Task[Unit] = {
  ...
  def publicMinersGet(host: String): Task[Unit] = {
  ...
  def publicStatsGet(host: String): Task[Unit] = {
    val path = "/public/stats"
...
class HttpServicePublicApi(service: HttpService) {
  ...
  def publicByCidCidGet(cid: String): Task[Unit] = {
    val path = "/public/by-cid/{cid}".replaceAll("\\{" + "cid" + "\\}",escape(cid.toString))
  ...
  def publicMinersFailuresMinerGet(miner: String): Task[Unit] = {
    val path = "/public/miners/failures/{miner}".replaceAll("\\{" + "miner" + "\\}",escape(miner.toString))
