...
object PublicApi {
  ...
  def publicByCidCidGet(host: String, cid: String): Task[String] = {
  ...
  def publicInfoGet(host: String): Task[String] = {
    implicit val returnTypeDecoder: EntityDecoder[String] = jsonOf[String]
  ...
  def publicStatsGet(host: String): Task[String] = {
    implicit val returnTypeDecoder: EntityDecoder[String] = jsonOf[String]
...
class HttpServicePublicApi(service: HttpService) {
  ...
  def publicByCidCidGet(cid: String): Task[String] = {
    implicit val returnTypeDecoder: EntityDecoder[String] = jsonOf[String]
  ...
  def publicStatsGet(): Task[String] = {
    implicit val returnTypeDecoder: EntityDecoder[String] = jsonOf[String]
