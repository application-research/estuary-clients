...
public class AutoretrieveApiController implements AutoretrieveApi {
    ...
    public ResponseEntity<String> autoretrieveHeartbeatPost(@Parameter(in = ParameterIn.HEADER, description = "Autoretrieve's auth token" ,required=true,schema=@Schema()) @RequestHeader(value="token", required=true) String token) {
