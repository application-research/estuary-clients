...
public interface PinningApi {
    ...
    ResponseEntity<PinnerIpfsListPinStatusResponse> pinningPinsGet();
    ...
    @RequestMapping(value = "/pinning/pins/{pinid}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<PinnerIpfsPinStatusResponse> pinningPinsPinidGet(@Parameter(in = ParameterIn.PATH, description = "cid", required=true, schema=@Schema()) @PathVariable("pinid") String pinid);
