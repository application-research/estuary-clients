...
open class DealsAPI: APIBase {
     ...
     */
    open class func dealEstimatePost(body: ApiEstimateDealBody, completion: @escaping ((_ data: String?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func dealTransferStatusPost(body: ApiChannelIDParam, completion: @escaping ((_ data: String?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func dealsMakeMinerPost(body: String, miner: String, completion: @escaping ((_ data: String?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func storageProvidersStorageQueryCidGet(cid: String, completion: @escaping ((_ data: String?, _ error: ErrorResponse?) -> Void)) {
