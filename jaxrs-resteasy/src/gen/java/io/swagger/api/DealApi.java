...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaResteasyServerCodegen", date = "2022-11-22T22:05:01.608Z[GMT]")public class DealApi  {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "500", description = "Internal Server Error", content = @Content(mediaType = "application/json", schema = @Schema(implementation = UtilHttpError.class))) })
    public Response dealTransferStatusPost(@Parameter(description = "Channel ID" ,required=true) MainChannelIDParam body,@Context SecurityContext securityContext)
    throws NotFoundException {
