    ...
    .apply {
      ...
      //       It could be the authentication block is being abused here. Until this is resolved, swallow duplicate exceptions.
        ...
        try {
            ...
            application.environment.log.warn("authentication block for '/admin/autoretrieve/init' is duplicated in code. " +
            "Generated endpoints may need to be merged under a 'route' entry.")
        }
    }

    get<Paths.adminAutoretrieveListGet> {  it: Paths.adminAutoretrieveListGet ->
        val principal = call.authentication.principal<ApiPrincipal>()
    ...
    .apply {
      ...
      //       It could be the authentication block is being abused here. Until this is resolved, swallow duplicate exceptions.
        ...
        try {
            ...
            application.environment.log.warn("authentication block for '/admin/autoretrieve/list' is duplicated in code. " +
            "Generated endpoints may need to be merged under a 'route' entry.")
        }
    }
    ...
    .apply {
      ...
      //       It could be the authentication block is being abused here. Until this is resolved, swallow duplicate exceptions.
        ...
        try {
            ...
            application.environment.log.warn("authentication block for '/autoretrieve/heartbeat' is duplicated in code. " +
            "Generated endpoints may need to be merged under a 'route' entry.")
        }
    }
}
