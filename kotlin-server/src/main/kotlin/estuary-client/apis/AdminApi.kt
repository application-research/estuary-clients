...
fun Route.AdminApi() {
    ...
    get<Paths.adminSystemConfigGet> {  it: Paths.adminSystemConfigGet ->
        val principal = call.authentication.principal<ApiPrincipal>()
    ...
    .apply {
      ...
      //       It could be the authentication block is being abused here. Until this is resolved, swallow duplicate exceptions.
        ...
        try {
            ...
            application.environment.log.warn("authentication block for '/admin/system/config' is duplicated in code. " +
            "Generated endpoints may need to be merged under a 'route' entry.")
        }
    }

    get<Paths.adminUsersGet> {  it: Paths.adminUsersGet ->
        val principal = call.authentication.principal<ApiPrincipal>()
    ...
    .apply {
      ...
      //       It could be the authentication block is being abused here. Until this is resolved, swallow duplicate exceptions.
        ...
        try {
            ...
            application.environment.log.warn("authentication block for '/admin/users' is duplicated in code. " +
            "Generated endpoints may need to be merged under a 'route' entry.")
        }
    }
}
