...
pub struct PeeringApiClient<C: hyper::client::Connect> {
    configuration: Rc<configuration::Configuration<C>>,
}

impl<C: hyper::client::Connect> PeeringApiClient<C> {
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> PeeringApiClient<C> {
        PeeringApiClient {
...
impl<C: hyper::client::Connect>PeeringApi for PeeringApiClient<C> {
    fn admin_peering_peers_delete(&self, peer_ids: Vec<bool>) -> Box<Future<Item = String, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/admin/peering/peers?{}", configuration.base_path, query_string);
    ...
    fn admin_peering_start_post(&self, ) -> Box<Future<Item = String, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/admin/peering/start?{}", configuration.base_path, query_string);
    ...
    fn admin_peering_status_get(&self, ) -> Box<Future<Item = String, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/admin/peering/status?{}", configuration.base_path, query_string);
    ...
    fn admin_peering_stop_post(&self, ) -> Box<Future<Item = String, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/admin/peering/stop?{}", configuration.base_path, query_string);
