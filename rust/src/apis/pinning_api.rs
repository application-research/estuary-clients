...
pub struct PinningApiClient<C: hyper::client::Connect> {
    configuration: Rc<configuration::Configuration<C>>,
}

impl<C: hyper::client::Connect> PinningApiClient<C> {
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> PinningApiClient<C> {
        PinningApiClient {
...
impl<C: hyper::client::Connect>PinningApi for PinningApiClient<C> {
    ...
    fn pinning_pins_pinid_delete(&self, pinid: &str) -> Box<Future<Item = String, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/pinning/pins/{pinid}?{}", configuration.base_path, query_string, pinid=pinid);
