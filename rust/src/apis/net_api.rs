...
pub struct NetApiClient<C: hyper::client::Connect> {
    configuration: Rc<configuration::Configuration<C>>,
}

impl<C: hyper::client::Connect> NetApiClient<C> {
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> NetApiClient<C> {
        NetApiClient {
...
impl<C: hyper::client::Connect>NetApi for NetApiClient<C> {
    fn net_addrs_get(&self, ) -> Box<Future<Item = String, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/net/addrs?{}", configuration.base_path, query_string);
