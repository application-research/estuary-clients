...
pub trait CollectionsApi {
    ...
    fn collections_get(&self, id: i32) -> Box<Future<Item = Vec<::models::MainCollection>, Error = Error<serde_json::Value>>>;
    fn collections_post(&self, body: ::models::MainCreateCollectionBody) -> Box<Future<Item = ::models::MainCollection, Error = Error<serde_json::Value>>>;
}
...
impl<C: hyper::client::Connect>CollectionsApi for CollectionsApiClient<C> {
    ...
    fn collections_get(&self, id: i32) -> Box<Future<Item = Vec<::models::MainCollection>, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/collections/?{}", configuration.base_path, query_string, id=id);
        ...
        configuration.client.request(req)
            ...
            .and_then(|body| {
                let parsed: Result<Vec<::models::MainCollection>, _> = serde_json::from_slice(&body);
                parsed.map_err(|e| Error::from(e))
            })
        )
    }
    ...
    fn collections_post(&self, body: ::models::MainCreateCollectionBody) -> Box<Future<Item = ::models::MainCollection, Error = Error<serde_json::Value>>> {
        ...
        configuration.client.request(req)
            ...
            .and_then(|body| {
                let parsed: Result<::models::MainCollection, _> = serde_json::from_slice(&body);
                parsed.map_err(|e| Error::from(e))
            })
        )
    }
