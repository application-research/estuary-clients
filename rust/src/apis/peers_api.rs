...
pub struct PeersApiClient<C: hyper::client::Connect> {
    configuration: Rc<configuration::Configuration<C>>,
}

impl<C: hyper::client::Connect> PeersApiClient<C> {
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> PeersApiClient<C> {
        PeersApiClient {
