...
pub struct PublicApiClient<C: hyper::client::Connect> {
    configuration: Rc<configuration::Configuration<C>>,
}

impl<C: hyper::client::Connect> PublicApiClient<C> {
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> PublicApiClient<C> {
        PublicApiClient {
...
impl<C: hyper::client::Connect>PublicApi for PublicApiClient<C> {
    fn public_by_cid_cid_get(&self, cid: &str) -> Box<Future<Item = String, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/public/by-cid/{cid}?{}", configuration.base_path, query_string, cid=cid);
    ...
    fn public_info_get(&self, ) -> Box<Future<Item = String, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/public/info?{}", configuration.base_path, query_string);
    ...
    fn public_metrics_deals_on_chain_get(&self, ) -> Box<Future<Item = String, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/public/metrics/deals-on-chain?{}", configuration.base_path, query_string);
    ...
    fn public_miners_deals_miner_get(&self, miner: &str, ignore_failed: &str) -> Box<Future<Item = String, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/public/miners/deals/{miner}?{}", configuration.base_path, query_string, miner=miner);
    ...
    fn public_miners_failures_miner_get(&self, miner: &str) -> Box<Future<Item = String, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/public/miners/failures/{miner}?{}", configuration.base_path, query_string, miner=miner);
    ...
    fn public_miners_get(&self, ) -> Box<Future<Item = String, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/public/miners?{}", configuration.base_path, query_string);
    ...
    fn public_miners_stats_miner_get(&self, miner: &str) -> Box<Future<Item = String, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/public/miners/stats/{miner}?{}", configuration.base_path, query_string, miner=miner);
    ...
    fn public_net_addrs_get(&self, ) -> Box<Future<Item = Vec<String>, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/public/net/addrs?{}", configuration.base_path, query_string);
    ...
    fn public_net_peers_get(&self, ) -> Box<Future<Item = Vec<String>, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/public/net/peers?{}", configuration.base_path, query_string);
    ...
    fn public_stats_get(&self, ) -> Box<Future<Item = String, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/public/stats?{}", configuration.base_path, query_string);
