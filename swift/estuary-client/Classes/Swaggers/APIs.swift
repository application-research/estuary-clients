...
public class estuary-clientAPI {
    public static var basePath = "https://api.estuary.tech"
...
public class RequestBuilder<T> {
    ...
    required public init(method: String, URLString: String, parameters: [String:AnyObject]?, isBody: Bool, headers: [String:String] = [:]) {
        ...
        addHeaders(estuary-clientAPI.customHeaders)
    }
    ...
    public func addCredential() -> Self {
        self.credential = estuary-clientAPI.credential
        return self
    }
}
