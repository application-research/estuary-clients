...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyDIServerCodegen", date = "2022-12-21T01:22:10.980Z[GMT]")public class StorageProvidersApi  {

   private StorageProvidersApiService delegate;

   protected StorageProvidersApi() {
   }

   @javax.inject.Inject
   public StorageProvidersApi(StorageProvidersApiService delegate) {
