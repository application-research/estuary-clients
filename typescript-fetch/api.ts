...
export const ContentApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        contentCreatePost(body: UtilContentCreateBody, ignoreDupes?: string, options: any = {}): FetchArgs {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
...
export const ContentApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        contentCreatePost(body: UtilContentCreateBody, ignoreDupes?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<string> {
            const localVarFetchArgs = ContentApiFetchParamCreator(configuration).contentCreatePost(body, ignoreDupes, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const ContentApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        contentCreatePost(body: UtilContentCreateBody, ignoreDupes?: string, options?: any) {
            return ContentApiFp(configuration).contentCreatePost(body, ignoreDupes, options)(fetch, basePath);
        },
        /**
         * This endpoint lists all content with deals
         * @summary Content with deals
...
export class ContentApi extends BaseAPI {
     ...
     * @memberof ContentApi
     */
    public contentCreatePost(body: UtilContentCreateBody, ignoreDupes?: string, options?: any) {
        return ContentApiFp(this.configuration).contentCreatePost(body, ignoreDupes, options)(this.fetch, this.basePath);
    }
...
export const DealsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        dealsMakeMinerPost(body: string, miner: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<string> {
