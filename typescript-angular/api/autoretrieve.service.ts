...
export class AutoretrieveService {
     ...
     */
    public adminAutoretrieveInitPostForm(addresses: string, pubKey: string, observe?: 'body', reportProgress?: boolean): Observable<string>;
    public adminAutoretrieveInitPostForm(addresses: string, pubKey: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<string>>;
    public adminAutoretrieveInitPostForm(addresses: string, pubKey: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<string>>;
    public adminAutoretrieveInitPostForm(addresses: string, pubKey: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (addresses !== undefined) {
            formParams = formParams.append('addresses', <any>addresses) as any || formParams;
        }
        if (pubKey !== undefined) {
            formParams = formParams.append('pubKey', <any>pubKey) as any || formParams;
        }

        return this.httpClient.request<string>('post',`${this.basePath}/admin/autoretrieve/init`,
            {
    ...
    public adminAutoretrieveListGet(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<string>('get',`${this.basePath}/admin/autoretrieve/list`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public autoretrieveHeartbeatPost(token: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<string>('post',`${this.basePath}/autoretrieve/heartbeat`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
