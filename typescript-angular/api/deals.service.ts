...
export class DealsService {
    ...
    public dealEstimatePost(body: ApiEstimateDealBody, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<string>('post',`${this.basePath}/deal/estimate`,
            {
                body: body,
    ...
    public dealInfoDealidGet(dealid: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<string>('get',`${this.basePath}/deal/info/${encodeURIComponent(String(dealid))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public dealProposalPropcidGet(propcid: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<string>('get',`${this.basePath}/deal/proposal/${encodeURIComponent(String(propcid))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public dealQueryMinerGet(miner: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<string>('get',`${this.basePath}/deal/query/${encodeURIComponent(String(miner))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public dealStatusByProposalPropcidGet(propcid: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<string>('get',`${this.basePath}/deal/status-by-proposal/${encodeURIComponent(String(propcid))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public dealStatusMinerPropcidGet(miner: string, propcid: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<string>('get',`${this.basePath}/deal/status/${encodeURIComponent(String(miner))}/${encodeURIComponent(String(propcid))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public dealTransferInProgressGet(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<string>('get',`${this.basePath}/deal/transfer/in-progress`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public dealTransferStatusPost(body: ApiChannelIDParam, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<string>('post',`${this.basePath}/deal/transfer/status`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public dealsFailuresGet(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<string>('get',`${this.basePath}/deals/failures`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public dealsMakeMinerPost(body: string, miner: string, observe?: 'body', reportProgress?: boolean): Observable<string>;
    public dealsMakeMinerPost(body: string, miner: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<string>>;
    public dealsMakeMinerPost(body: string, miner: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<string>>;
    public dealsMakeMinerPost(body: string, miner: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<string>('post',`${this.basePath}/deals/make/${encodeURIComponent(String(miner))}`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public dealsStatusDealGet(deal: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<string>('get',`${this.basePath}/deals/status/${encodeURIComponent(String(deal))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public publicDealsFailuresGet(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<string>('get',`${this.basePath}/public/deals/failures`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public publicMinersStorageQueryMinerGet(miner: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<string>('get',`${this.basePath}/public/miners/storage/query/${encodeURIComponent(String(miner))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public storageProvidersStorageQueryCidGet(cid: string, observe?: 'body', reportProgress?: boolean): Observable<string>;
    public storageProvidersStorageQueryCidGet(cid: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<string>>;
    public storageProvidersStorageQueryCidGet(cid: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<string>>;
    public storageProvidersStorageQueryCidGet(cid: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (cid === null || cid === undefined) {
            throw new Error('Required parameter cid was null or undefined when calling storageProvidersStorageQueryCidGet.');
        }
        ...
        return this.httpClient.request<string>('get',`${this.basePath}/storage-providers/storage/query/${encodeURIComponent(String(cid))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
