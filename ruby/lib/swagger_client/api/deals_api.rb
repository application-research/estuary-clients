...
module SwaggerClient
  class DealsApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [String]
    def storage_providers_storage_query_cid_get(cid, opts = {})
      data, _status_code, _headers = storage_providers_storage_query_cid_get_with_http_info(cid, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(String, Integer, Hash)>] String data, response status code and response headers
    def storage_providers_storage_query_cid_get_with_http_info(cid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DealsApi.storage_providers_storage_query_cid_get ...'
      end
      # verify the required parameter 'cid' is set
      if @api_client.config.client_side_validation && cid.nil?
        fail ArgumentError, "Missing the required parameter 'cid' when calling DealsApi.storage_providers_storage_query_cid_get"
      end
      # resource path
      local_var_path = '/storage-providers/storage/query/{cid}'.sub('{' + 'cid' + '}', cid.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DealsApi#storage_providers_storage_query_cid_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
