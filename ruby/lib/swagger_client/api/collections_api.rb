...
module SwaggerClient
  class CollectionsApi
    ...
    # @param coluuid coluuid
    # @param content_ids Content IDs to add to collection
    # @param [Hash] opts the optional parameters
    # @return [String]
    def collections_coluuid_post(coluuid, content_ids, opts = {})
      data, _status_code, _headers = collections_coluuid_post_with_http_info(coluuid, content_ids, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(String, Fixnum, Hash)>] String data, response status code and response headers
    def collections_coluuid_post_with_http_info(coluuid, content_ids, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && content_ids.nil?
        fail ArgumentError, "Missing the required parameter 'content_ids' when calling CollectionsApi.collections_coluuid_post"
      end
      # resource path
      local_var_path = '/collections/{coluuid}'.sub('{' + 'coluuid' + '}', coluuid.to_s)
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(content_ids)
      auth_names = ['bearerAuth']
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        :header_params => header_params,
        :query_params => query_params,
