...
export const PeeringApiFp = function(configuration?: Configuration) {
    return {
        ...
        async adminPeeringPeersDelete(body: Array<boolean>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<string>>> {
            const localVarAxiosArgs = await PeeringApiAxiosParamCreator(configuration).adminPeeringPeersDelete(body, options);
...
export const PeeringApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        async adminPeeringPeersDelete(body: Array<boolean>, options?: AxiosRequestConfig): Promise<AxiosResponse<string>> {
            return PeeringApiFp(configuration).adminPeeringPeersDelete(body, options).then((request) => request(axios, basePath));
        },
        /**
         * This endpoint can be used to list all peers on Peering Service
         * @summary List all Peering peers
...
export class PeeringApi extends BaseAPI {
    ...
    public async adminPeeringPeersDelete(body: Array<boolean>, options?: AxiosRequestConfig) : Promise<AxiosResponse<string>> {
        return PeeringApiFp(this.configuration).adminPeeringPeersDelete(body, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * This endpoint can be used to list all peers on Peering Service
     * @summary List all Peering peers
