...
-spec public_by_cid_cid_get(ctx:ctx(), binary()) -> {ok, [], swagger_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), swagger_utils:response_info()}.
public_by_cid_cid_get(Ctx, Cid) ->
    public_by_cid_cid_get(Ctx, Cid, #{}).

-spec public_by_cid_cid_get(ctx:ctx(), binary(), maps:map()) -> {ok, [], swagger_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), swagger_utils:response_info()}.
...
-spec public_info_get(ctx:ctx()) -> {ok, [], swagger_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), swagger_utils:response_info()}.
public_info_get(Ctx) ->
    public_info_get(Ctx, #{}).

-spec public_info_get(ctx:ctx(), maps:map()) -> {ok, [], swagger_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), swagger_utils:response_info()}.
...
-spec public_miners_failures_miner_get(ctx:ctx(), binary()) -> {ok, [], swagger_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), swagger_utils:response_info()}.
public_miners_failures_miner_get(Ctx, Miner) ->
    public_miners_failures_miner_get(Ctx, Miner, #{}).

-spec public_miners_failures_miner_get(ctx:ctx(), binary(), maps:map()) -> {ok, [], swagger_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), swagger_utils:response_info()}.
...
%% @doc Get all miners
%% This endpoint returns all miners
-spec public_miners_get(ctx:ctx()) -> {ok, [], swagger_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), swagger_utils:response_info()}.
public_miners_get(Ctx) ->
    public_miners_get(Ctx, #{}).

-spec public_miners_get(ctx:ctx(), maps:map()) -> {ok, [], swagger_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), swagger_utils:response_info()}.
...
-spec public_net_addrs_get(ctx:ctx()) -> {ok, [binary()], swagger_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), swagger_utils:response_info()}.
public_net_addrs_get(Ctx) ->
    public_net_addrs_get(Ctx, #{}).

-spec public_net_addrs_get(ctx:ctx(), maps:map()) -> {ok, [binary()], swagger_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), swagger_utils:response_info()}.
...
-spec public_net_peers_get(ctx:ctx()) -> {ok, [binary()], swagger_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), swagger_utils:response_info()}.
public_net_peers_get(Ctx) ->
    public_net_peers_get(Ctx, #{}).

-spec public_net_peers_get(ctx:ctx(), maps:map()) -> {ok, [binary()], swagger_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), swagger_utils:response_info()}.
...
-spec public_stats_get(ctx:ctx()) -> {ok, [], swagger_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), swagger_utils:response_info()}.
public_stats_get(Ctx) ->
    public_stats_get(Ctx, #{}).

-spec public_stats_get(ctx:ctx(), maps:map()) -> {ok, [], swagger_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), swagger_utils:response_info()}.
