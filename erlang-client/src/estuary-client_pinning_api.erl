...
-spec pinning_pins_get(ctx:ctx()) -> {ok, [], estuary-client_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), estuary-client_utils:response_info()}.
pinning_pins_get(Ctx) ->
    pinning_pins_get(Ctx, #{}).

-spec pinning_pins_get(ctx:ctx(), maps:map()) -> {ok, [], estuary-client_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), estuary-client_utils:response_info()}.
...
-spec pinning_pins_pinid_get(ctx:ctx(), binary()) -> {ok, [], estuary-client_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), estuary-client_utils:response_info()}.
pinning_pins_pinid_get(Ctx, Pinid) ->
    pinning_pins_pinid_get(Ctx, Pinid, #{}).

-spec pinning_pins_pinid_get(ctx:ctx(), binary(), maps:map()) -> {ok, [], estuary-client_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), estuary-client_utils:response_info()}.
...
-spec pinning_pins_pinid_post(ctx:ctx(), binary()) -> {ok, [], estuary-client_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), estuary-client_utils:response_info()}.
pinning_pins_pinid_post(Ctx, Pinid) ->
    pinning_pins_pinid_post(Ctx, Pinid, #{}).

-spec pinning_pins_pinid_post(ctx:ctx(), binary(), maps:map()) -> {ok, [], estuary-client_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), estuary-client_utils:response_info()}.
...
-spec pinning_pins_post(ctx:ctx(), binary(), binary()) -> {ok, [], estuary-client_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), estuary-client_utils:response_info()}.
pinning_pins_post(Ctx, Cid, Name) ->
    pinning_pins_post(Ctx, Cid, Name, #{}).

-spec pinning_pins_post(ctx:ctx(), binary(), binary(), maps:map()) -> {ok, [], estuary-client_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), estuary-client_utils:response_info()}.
