...
signals:
    ...
    void userApiKeysKeyDeleteSignal(QString* summary);
    ...
    void userApiKeysKeyDeleteSignalE(QString* summary, QNetworkReply::NetworkError error_type, QString& error_str);
