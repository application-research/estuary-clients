...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PinnerIpfsPin', function() {
      beforeEach(function() {
        instance = new EstuaryClient.PinnerIpfsPin();
      });

      it('should create an instance of PinnerIpfsPin', function() {
        // TODO: update the code to test PinnerIpfsPin
        expect(instance).to.be.a(EstuaryClient.PinnerIpfsPin);
      });
