...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PinnerIpfsListPinStatusResponse', function() {
      beforeEach(function() {
        instance = new EstuaryClient.PinnerIpfsListPinStatusResponse();
      });

      it('should create an instance of PinnerIpfsListPinStatusResponse', function() {
        // TODO: update the code to test PinnerIpfsListPinStatusResponse
        expect(instance).to.be.a(EstuaryClient.PinnerIpfsListPinStatusResponse);
      });
