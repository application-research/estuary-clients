...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('StatusPinningStatus', function() {
      beforeEach(function() {
        instance = EstuaryClient.StatusPinningStatus;
      });

      it('should create an instance of StatusPinningStatus', function() {
        // TODO: update the code to test StatusPinningStatus
