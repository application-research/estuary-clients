...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ApiEstimateDealBody', function() {
      beforeEach(function() {
        instance = new EstuaryClient.ApiEstimateDealBody();
      });

      it('should create an instance of ApiEstimateDealBody', function() {
        // TODO: update the code to test ApiEstimateDealBody
        expect(instance).to.be.a(EstuaryClient.ApiEstimateDealBody);
      });
