...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ApiChannelIDParam', function() {
      beforeEach(function() {
        instance = new EstuaryClient.ApiChannelIDParam();
      });

      it('should create an instance of ApiChannelIDParam', function() {
        // TODO: update the code to test ApiChannelIDParam
        expect(instance).to.be.a(EstuaryClient.ApiChannelIDParam);
      });
