...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ApiStorageProviderResp', function() {
      beforeEach(function() {
        instance = new EstuaryClient.ApiStorageProviderResp();
      });

      it('should create an instance of ApiStorageProviderResp', function() {
        // TODO: update the code to test ApiStorageProviderResp
        expect(instance).to.be.a(EstuaryClient.ApiStorageProviderResp);
      });
