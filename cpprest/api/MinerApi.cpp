...
MinerApi::MinerApi( std::shared_ptr<ApiClient> apiClient )
...
pplx::task<utility::string_t> MinerApi::publicMinersDealsMinerGet(utility::string_t miner, boost::optional<utility::string_t> ignoreFailed)
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("MinerApi->publicMinersDealsMinerGet does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("MinerApi->publicMinersDealsMinerGet does not consume any supported media type"));
    }
...
pplx::task<utility::string_t> MinerApi::publicMinersStatsMinerGet(utility::string_t miner)
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("MinerApi->publicMinersStatsMinerGet does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("MinerApi->publicMinersStatsMinerGet does not consume any supported media type"));
    }
