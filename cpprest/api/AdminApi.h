...
#ifndef IO_SWAGGER_CLIENT_API_AdminApi_H_
#define IO_SWAGGER_CLIENT_API_AdminApi_H_
...
{
public:
    AdminApi( std::shared_ptr<ApiClient> apiClient );
    virtual ~AdminApi();
    /// <summary>
    ...
    /// </remarks>
    pplx::task<utility::string_t> adminSystemConfigGet(
    );
    /// <summary>
    /// Get all users
    /// </summary>
    ...
    /// </remarks>
    pplx::task<utility::string_t> adminUsersGet(
    );
...
#endif /* IO_SWAGGER_CLIENT_API_AdminApi_H_ */
