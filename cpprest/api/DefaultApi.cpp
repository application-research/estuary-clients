...
pplx::task<void> DefaultApi::dealTransferStatusPost()
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("DefaultApi->dealTransferStatusPost does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("DefaultApi->dealTransferStatusPost does not consume any supported media type"));
    }
