...
MetricsApi::MetricsApi( std::shared_ptr<ApiClient> apiClient )
...
pplx::task<utility::string_t> MetricsApi::publicMetricsDealsOnChainGet()
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("MetricsApi->publicMetricsDealsOnChainGet does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("MetricsApi->publicMetricsDealsOnChainGet does not consume any supported media type"));
    }
