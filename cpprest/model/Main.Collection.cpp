...
void Main.Collection::validate()
{
    // TODO: implement validation
}

web::json::value Main.Collection::toJson() const
{
...
void Main.Collection::fromJson(web::json::value& val)
{
...
void Main.Collection::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void Main.Collection::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t Main.Collection::getCid() const
{
    return m_Cid;
}


void Main.Collection::setCid(utility::string_t value)
{
    m_Cid = value;
    m_CidIsSet = true;
}
bool Main.Collection::cidIsSet() const
{
    return m_CidIsSet;
}

void Main.Collection::unsetCid()
{
    m_CidIsSet = false;
}

utility::string_t Main.Collection::getCreatedAt() const
{
    return m_CreatedAt;
}


void Main.Collection::setCreatedAt(utility::string_t value)
{
    m_CreatedAt = value;
    m_CreatedAtIsSet = true;
}
bool Main.Collection::createdAtIsSet() const
{
    return m_CreatedAtIsSet;
}

void Main.Collection::unsetCreatedAt()
{
    m_CreatedAtIsSet = false;
}

utility::string_t Main.Collection::getDescription() const
{
    return m_Description;
}


void Main.Collection::setDescription(utility::string_t value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}
bool Main.Collection::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void Main.Collection::unsetDescription()
{
    m_DescriptionIsSet = false;
}

utility::string_t Main.Collection::getName() const
{
    return m_Name;
}


void Main.Collection::setName(utility::string_t value)
{
    m_Name = value;
    m_NameIsSet = true;
}
bool Main.Collection::nameIsSet() const
{
    return m_NameIsSet;
}

void Main.Collection::unsetName()
{
    m_NameIsSet = false;
}

int32_t Main.Collection::getUserId() const
{
    return m_UserId;
}


void Main.Collection::setUserId(int32_t value)
{
    m_UserId = value;
    m_UserIdIsSet = true;
}
bool Main.Collection::userIdIsSet() const
{
    return m_UserIdIsSet;
}

void Main.Collection::unsetUserId()
{
    m_UserIdIsSet = false;
}

utility::string_t Main.Collection::getUuid() const
{
    return m_Uuid;
}


void Main.Collection::setUuid(utility::string_t value)
{
    m_Uuid = value;
    m_UuidIsSet = true;
}
bool Main.Collection::uuidIsSet() const
{
    return m_UuidIsSet;
}

void Main.Collection::unsetUuid()
{
    m_UuidIsSet = false;
}
