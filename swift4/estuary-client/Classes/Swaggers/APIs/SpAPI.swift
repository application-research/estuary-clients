...
open class SpAPI {
     ...
     */
    open class func storageProvidersClaimPost(body: MinerClaimMinerBody, completion: @escaping ((_ data: GithubComApplicationResearchEstuaryApiV2ClaimResponse?,_ error: Error?) -> Void)) {
  ...
  "success" : true
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func storageProvidersClaimSpGet(sp: String, completion: @escaping ((_ data: GithubComApplicationResearchEstuaryApiV2ClaimMsgResponse?,_ error: Error?) -> Void)) {
  ...
  "hexmsg" : "hexmsg"
    ...
    /**
     ...
     - parameter sp: (path) Filter by storage provider      - parameter ignoreFailed: (query) Ignore Failed (optional)
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func storageProvidersDealsSpGet(sp: String, ignoreFailed: String? = nil, completion: @escaping ((_ data: String?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func storageProvidersFailuresSpGet(sp: String, completion: @escaping ((_ data: String?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func storageProvidersGet(completion: @escaping ((_ data: [ApiStorageProviderResp]?,_ error: Error?) -> Void)) {
  ...
  "suspended" : true
    ...
    /**
     ...
     - parameter body: (body) Storage Provider set info params      - parameter sp: (path) Storage Provider to set info for 
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func storageProvidersSetInfoSpPut(body: MinerMinerSetInfoParams, sp: String, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func storageProvidersStatsSpGet(sp: String, completion: @escaping ((_ data: String?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter body: (body) Suspend Storage Provider Body      - parameter sp: (path) Storage Provider to suspend 
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func storageProvidersSuspendSpPost(body: MinerSuspendMinerBody, sp: String, completion: @escaping ((_ data: [String:String]?,_ error: Error?) -> Void)) {
  ...
  "key" : ""
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func storageProvidersUnsuspendSpPut(sp: String, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
