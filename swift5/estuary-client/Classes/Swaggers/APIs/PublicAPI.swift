...
open class PublicAPI {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func publicByCidCidGet(cid: String, completion: @escaping ((_ data: String?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func publicInfoGet(completion: @escaping ((_ data: ApiPublicNodeInfo?,_ error: Error?) -> Void)) {
