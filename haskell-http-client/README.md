## Swagger Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `Estuary API` 

The library in `lib` provides auto-generated-from-Swagger [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the Estuary API API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | Estuary                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | estuary                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | EstuaryConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | EstuaryRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| Estuary.Client    | use the "dispatch" functions to send requests       |
| Estuary.Core      | core funcions, config and request types             |
| Estuary.API       | construct api requests                              |
| Estuary.Model     | describes api models                                |
| Estuary.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| Estuary.ModelLens | lenses for model fields                             |
| Estuary.Logging   | logging functions and utils                         |
