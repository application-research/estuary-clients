...
class DealsApi
{
    ...
    /**
     * Operation storageProvidersStorageQueryCidGet
     *
     * Query Ask
     *
     ...
     * @return string
     */
    public function storageProvidersStorageQueryCidGet($cid)
    {
        list($response) = $this->storageProvidersStorageQueryCidGetWithHttpInfo($cid);
        return $response;
    }

    /**
     * Operation storageProvidersStorageQueryCidGetWithHttpInfo
     *
     * Query Ask
     *
     * @param  string $cid CID (required)
     ...
     * @return array of string, HTTP status code, HTTP response headers (array of strings)
     */
    public function storageProvidersStorageQueryCidGetWithHttpInfo($cid)
    {
        $returnType = 'string';
        $request = $this->storageProvidersStorageQueryCidGetRequest($cid);
    ...
    /**
     * Operation storageProvidersStorageQueryCidGetAsync
     *
     * Query Ask
     *
     * @param  string $cid CID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function storageProvidersStorageQueryCidGetAsync($cid)
    {
        return $this->storageProvidersStorageQueryCidGetAsyncWithHttpInfo($cid)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation storageProvidersStorageQueryCidGetAsyncWithHttpInfo
     *
     * Query Ask
     *
     * @param  string $cid CID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function storageProvidersStorageQueryCidGetAsyncWithHttpInfo($cid)
    {
        $returnType = 'string';
        $request = $this->storageProvidersStorageQueryCidGetRequest($cid);
    ...
    /**
     * Create request for operation 'storageProvidersStorageQueryCidGet'
     *
     * @param  string $cid CID (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function storageProvidersStorageQueryCidGetRequest($cid)
    {
        // verify the required parameter 'cid' is set
        if ($cid === null || (is_array($cid) && count($cid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $cid when calling storageProvidersStorageQueryCidGet'
            );
        }

        $resourcePath = '/storage-providers/storage/query/{cid}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
