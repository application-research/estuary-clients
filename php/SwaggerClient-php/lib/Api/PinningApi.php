...
class PinningApi
{
     ...
     * @return \Swagger\Client\Model\PinnerIpfsListPinStatusResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\PinnerIpfsListPinStatusResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function pinningPinsGetWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\PinnerIpfsListPinStatusResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\PinnerIpfsListPinStatusResponse',
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\PinnerIpfsPinStatusResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\PinnerIpfsPinStatusResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function pinningPinsPinidGetWithHttpInfo($pinid)
    {
        $returnType = '\Swagger\Client\Model\PinnerIpfsPinStatusResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\PinnerIpfsPinStatusResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Swagger\Client\Model\PinnerIpfsPin $body New pin (required)
     ...
     * Add and pin object
     *
     * @param  \Swagger\Client\Model\PinnerIpfsPin $body Pin Body {cid:cid, name:name} (required)
