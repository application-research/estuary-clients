...
class ContentApi
{
     ...
     * @return string
     */
    public function adminInvitesPost($code)
    {
        list($response) = $this->adminInvitesPostWithHttpInfo($code);
        return $response;
    }

    /**
     * Operation adminInvitesPostWithHttpInfo
     *
     * Create an Estuary invite
     *
     * @param  string $code Invite code to be created (required)
     ...
     * @return array of string, HTTP status code, HTTP response headers (array of strings)
     */
    public function adminInvitesPostWithHttpInfo($code)
    {
        $returnType = 'string';
        $request = $this->adminInvitesPostRequest($code);
    ...
    /**
     * Operation adminInvitesPostAsync
     *
     * Create an Estuary invite
     *
     * @param  string $code Invite code to be created (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function adminInvitesPostAsync($code)
    {
        return $this->adminInvitesPostAsyncWithHttpInfo($code)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation adminInvitesPostAsyncWithHttpInfo
     *
     * Create an Estuary invite
     *
     * @param  string $code Invite code to be created (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function adminInvitesPostAsyncWithHttpInfo($code)
    {
        $returnType = 'string';
        $request = $this->adminInvitesPostRequest($code);
    ...
    /**
     * Create request for operation 'adminInvitesPost'
     *
     * @param  string $code Invite code to be created (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function adminInvitesPostRequest($code)
    {
        // verify the required parameter 'code' is set
        if ($code === null || (is_array($code) && count($code) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $code when calling adminInvitesPost'
            );
        }
