...
(defn admin-peering-peers-delete
  ...
  This endpoint can be used to remove a Peer from the Peering Service"
  []
  (:data (admin-peering-peers-delete-with-http-info)))
...
(defn admin-system-config-get-with-http-info
  "Get systems(estuary/shuttle) config
  This endpoint is used to get system configs."
  []
  (call-api "/admin/system/config" :get
            {:path-params   {}
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn admin-system-config-get
  "Get systems(estuary/shuttle) config
  This endpoint is used to get system configs."
  []
  (:data (admin-system-config-get-with-http-info)))

(defn admin-users-get-with-http-info
  "Get all users
...
(defn admin-users-get
  "Get all users
  This endpoint is used to get all users."
  []
  (:data (admin-users-get-with-http-info)))
