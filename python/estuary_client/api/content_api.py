...
class ContentApi(object):
    ...
    def admin_invites_get(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.admin_invites_get(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.admin_invites_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.admin_invites_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def admin_invites_get_with_http_info(self, **kwargs):  # noqa: E501
        """Get Estuary invites  # noqa: E501

        This endpoint is used to list all estuary invites.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.admin_invites_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method admin_invites_get" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def content_contents_get(self, limit, offset, **kwargs):  # noqa: E501
        """Get user contents  # noqa: E501

        This endpoint is used to get user contents  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.content_contents_get(limit, offset, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.content_contents_get_with_http_info(limit, offset, **kwargs)  # noqa: E501
        else:
            (data) = self.content_contents_get_with_http_info(limit, offset, **kwargs)  # noqa: E501
            return data

    def content_contents_get_with_http_info(self, limit, offset, **kwargs):  # noqa: E501
        """Get user contents  # noqa: E501

        This endpoint is used to get user contents  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.content_contents_get_with_http_info(limit, offset, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method content_contents_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('limit' not in params or
            ...
            raise ValueError("Missing the required parameter `limit` when calling `content_contents_get`")  # noqa: E501
        # verify the required parameter 'offset' is set
        if ('offset' not in params or
                params['offset'] is None):
            raise ValueError("Missing the required parameter `offset` when calling `content_contents_get`")  # noqa: E501
    ...
    def content_create_post(self, body, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param UtilContentCreateBody body: Content (required)
        :param str ignore_dupes: Ignore Dupes
        :return: str
                 If the method is called asynchronously,
                 returns the request thread.
