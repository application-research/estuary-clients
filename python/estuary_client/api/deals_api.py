...
class DealsApi(object):
    ...
    def storage_providers_storage_query_cid_get(self, cid, **kwargs):  # noqa: E501
        """Query Ask  # noqa: E501

        This endpoint returns the ask for a given CID  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.storage_providers_storage_query_cid_get(cid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.storage_providers_storage_query_cid_get_with_http_info(cid, **kwargs)  # noqa: E501
        else:
            (data) = self.storage_providers_storage_query_cid_get_with_http_info(cid, **kwargs)  # noqa: E501
            return data

    def storage_providers_storage_query_cid_get_with_http_info(self, cid, **kwargs):  # noqa: E501
        """Query Ask  # noqa: E501

        This endpoint returns the ask for a given CID  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.storage_providers_storage_query_cid_get_with_http_info(cid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method storage_providers_storage_query_cid_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('cid' not in params or
                params['cid'] is None):
            raise ValueError("Missing the required parameter `cid` when calling `storage_providers_storage_query_cid_get`")  # noqa: E501
